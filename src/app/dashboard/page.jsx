      ...
      <>
        <div className="px-[25px] sm:p-[30px] w-full flex-1 h-screen overflow-y-auto pt-[70px] lg:pt-8">
          ...
          <div className="flex-col h-[330px] flex xl:flex-row mb-32 xl:my-0 justify-between items-center gap-5 rounded-xl">
            ...
            <div className="w-full md:flex-[0.3] h-full shadow-[rgba(17,_17,_26,_0.15)_0px_0px_8px] rounded-xl p-7">
          ...
          <div className="flex-col flex xl:flex-row justify-between items-start gap-5 xl:my-7 rounded-xl">
            <div className="w-full md:flex-[0.7] h-full shadow-[rgba(17,_17,_26,_0.15)_0px_0px_8px] rounded-xl p-7">
              <div className="mb-6">
